...
function GuildLog:OnInitialize()
    ...
    print("|cff00ccff[GuildLog]|r Loaded. Type |cffffff00/glog|r to open, |cffffff00/glog scan|r to check for changes now, |cffffff00/glog stats|r for memory/CPU usage.")
end
